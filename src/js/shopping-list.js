...
import amazon from '../images/shopping_list/amazon.png';
import appleBooks from '../images/shopping_list/apple-books.png';
import bookShop from '../images/shopping_list/book-shop.png';
// import trash from '../images/trashh.svg#icon-bin';
const imageUrl = new URL('../images/shopping_list/trashh.svg#icon-bin', import.meta.url);
